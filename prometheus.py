...
url_up_metric = Gauge('sample_external_url_up', 'HTTP status up for the URL', ['url'])
response_time_metric = Gauge('sample_external_url_response_ms', 'Response time in ms for the URL', ['url'])
